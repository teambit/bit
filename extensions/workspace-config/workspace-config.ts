...
import ConsumerOverrides, { ConsumerOverridesOfComponent } from 'bit-bin/consumer/config/consumer-overrides';
import { BIT_JSONC, DEFAULT_LANGUAGE, COMPILER_ENV_TYPE } from 'bit-bin/constants';
import { PathOsBased, PathOsBasedAbsolute } from 'bit-bin/utils/path';
...
import { isFeatureEnabled } from 'bit-bin/api/consumer/lib/feature-toggle';
