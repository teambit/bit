...
import LegacyWorkspaceConfig from 'bit-bin/dist/consumer/config/workspace-config';
import ConsumerOverrides, { ConsumerOverridesOfComponent } from 'bit-bin/dist/consumer/config/consumer-overrides';
import { BIT_JSONC, DEFAULT_LANGUAGE, COMPILER_ENV_TYPE } from 'bit-bin/dist/constants';
...
import { isFeatureEnabled } from 'bit-bin/dist/api/consumer/lib/feature-toggle';
