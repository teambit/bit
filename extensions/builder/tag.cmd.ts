...
import { tagAction, tagAllAction } from 'bit-bin/dist/api/consumer';
import { TagResults, NOTHING_TO_TAG_MSG, AUTO_TAGGED_MSG } from 'bit-bin/dist/api/consumer/lib/tag';
import { isString } from 'bit-bin/dist/utils';
import { DEFAULT_BIT_RELEASE_TYPE, BASE_DOCS_DOMAIN, WILDCARD_HELP } from 'bit-bin/dist/constants';
import GeneralError from 'bit-bin/dist/error/general-error';
import hasWildcard from 'bit-bin/dist/utils/string/has-wildcard';
