...
​fpm -s dir -t deb -n bit -p ./releases --vendor 'Cocycles, LTD <team@bit.dev>' --maintainer 'Cocycles, LTD <team@bit.dev>' --version $VERSION --url https://bit.dev --description 'Easily share code between projects with your team' ./releases/bit-bin-linux=/usr/local/bin/bit
