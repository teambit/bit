...
describe('component url', () => {
  it('should convert to url', () => {
    ...
    expect(result).to.equal('https://bit.dev/teambit/component/component-id?version=0.0.312');
  });
  ...
  it('should not require version', () => {
    ...
    expect(result).to.equal('https://bit.dev/teambit/component/component-id');
  });
