...
export class MergeCmd implements Command {
  ...
  description = mergeCommand.description;
  helpUrl = mergeCommand.helpUrl;
  group = mergeCommand.group;
  arguments = mergeCommand.arguments;
  extendedDescription = mergeCommand.extendedDescription;
  alias = mergeCommand.alias;
  options = mergeCommand.options;
  loader = mergeCommand.loader;
