...
you can add the directory these files are located at and it'll change the root dir of the component accordingly`);
   ...
   * use that id instead.
   */
  private async _getIdAccordingToExistingComponent(currentId: BitIdStr): ComponentID {
    ...
    if (existingComponentId) return existingComponentId;
    // @todo: fix!
    // const defaultScope = this.defaultScope
    //   || (await this.workspace.componentDefaultScopeFromComponentDirAndName(rootDir, currentId))
