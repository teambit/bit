...
import { glob, isAutoGeneratedFile, isDir, pathNormalizeToLinux } from '@teambit/legacy.utils';
import { PathLinux, PathLinuxRelative, PathOsBased } from '@teambit/legacy.utils';
import {
  DuplicateIds,
  EmptyDirectory,
  ExcludedMainFile,
