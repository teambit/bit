...
export class Component {
  ...
  async getLogs(filter?: { type?: string; offset?: number; limit?: number; versionOffset?: string }) {
    const id = !filter?.versionOffset ? ComponentID.fromString(this.id.toStringWithoutVersion()) : this.id;
