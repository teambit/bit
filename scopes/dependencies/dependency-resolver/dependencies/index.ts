...
export { Dependency, DependencyLifecycleType, SerializedDependency } from './dependency';
...
export { LIFECYCLE_TYPE_BY_KEY_NAME, KEY_NAME_BY_LIFECYCLE_TYPE } from './constants';
