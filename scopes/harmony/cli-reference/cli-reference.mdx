...
| **Option**       | **Option alias** | **Description**                                                                                                                                                                                                                                              |
| ---------------- | :--------------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `--parent`       |       `-p`       | compare the specified "version" (or the current version if not specified) to its nearest meaningful ancestor, showing what changed in that version. ancestors that are hidden or identical (e.g. the merged snap a release-tag was created from) are skipped |
