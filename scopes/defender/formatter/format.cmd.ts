...
export class FormatCmd implements Command {
  ...
  description = formatCommand.description;
  extendedDescription = formatCommand.extendedDescription;
  arguments = formatCommand.arguments;
  group = formatCommand.group;
  helpUrl = formatCommand.helpUrl;
  options = formatCommand.options;
