...
export class TestCmd implements Command {
  ...
  extendedDescription = testCommand.extendedDescription;
  helpUrl = testCommand.helpUrl;
  arguments = testCommand.arguments;
  alias = testCommand.alias;
  group = testCommand.group;
  options = testCommand.options;
