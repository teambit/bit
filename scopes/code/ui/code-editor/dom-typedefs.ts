...
import * as CSS from './css-typedefs';
 ...
 */
type ComponentProps<T extends ReactType> = T extends ComponentType<infer P>
  ? P
  : T extends keyof JSX.IntrinsicElements
  ? JSX.IntrinsicElements[T]
  : {};
type ComponentPropsWithRef<T extends ReactType> = T extends ComponentClass<infer P>
