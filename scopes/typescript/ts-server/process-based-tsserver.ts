...
// async function run() {
//     tspClient.start()
//     const file = '/Users/davidfirst/teambit/bit/scopes/harmony/bit/app.ts';
//     const file2 = '/Users/davidfirst/teambit/bit/scopes/harmony/bit/bit.aspect.ts';
...
//     // const projErr = await getProjectErr();
//     // console.log("🚀 ~ file: tsp-client.ts ~ line 309 ~ run ~ projErr", projErr)
//     console.time('diag')
//     const diag = await getDiag([file, file2]);
//     console.timeEnd('diag')
//     console.log(Date.now(), "🚀 ~ file: tsp-client.ts ~ line 304 ~ run ~ diag", diag)

//     console.time('diag2')
//     const file3 = '/Users/davidfirst/teambit/bit/scopes/compilation/compiler/compiler.cmd.ts';
//     const diag2 = await getDiag([file3]);
//     console.log("🚀 ~ file: tsp-client.ts ~ line 320 ~ run ~ diag2", diag2)
//     console.timeEnd('diag2')

//     console.time('quick')
//     const info = await getQuickInfo(file, position);
//     console.timeEnd('quick')
//     console.log(Date.now(), "🚀 ~ file: tsp-client.ts ~ line 293 ~ run ~ info", info)
//     tspClient.kill();
// }

// run().then((res) => console.log('res', res)).catch(err => {
//     console.log('err', err);
//     tspClient.kill();
// });

// console.log('tspClient', tspClient);
