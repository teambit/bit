...
| ------------------- | ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| install size        | **1.2 GB**                | **159 MB** (59 MB bundle + 68 MB externals + \~32 MB shims, incl. the 16.8 MB pre-bundled UI/preview — §17i). Measured 2026-09-06 on a fresh `npm run bundle` from current HEAD (`e2245600e`). |
