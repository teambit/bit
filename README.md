...
**Bit makes it easier to share and manage changes to common code in multiple repositories**. 
...
Bit works with Git and NPM to provide greater discoverability and less overhead for sharing source code and managing changes in multiple repositories and projects - so you can save your energy for building new things.
