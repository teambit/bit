...
Bit is a toolchain for development of **composable software**. It makes the composition of applications from independently versioned components simple and fast.
...
- 🛫 **Lanes**. Propose changes to components collaborate on them with others.
