...
export class Graph<N, E> {
  ...
  getSuccessorsLayersRecursively(
    ...
    order: 'fromSource' | 'fromLastNodes' = 'fromSource'
  ): string[][] | never {
  ...
  private _innerRecurSuccessorsArray(
    nodeKey: string,
  ...
  private _innerRecurSuccessorsGraph(
    nodeKey: string,
  ...
  private _innerRecurSuccessorsLayers(
    nodeKeys: string[],
    layers: string[][],
    floor: number,
    filterPredicate: (data: E) => boolean = returnTrue
  ...
  private _innerRecurPredecessorsArray(
    nodeKey: string,
  ...
  private _innerRecurPredecessorsGraph(
    nodeKey: string,
  ...
  private _innerRecurPredecessorsLayers(
    nodeKeys: string[],
    layers: string[][],
    floor: number,
    filterPredicate: (data: E) => boolean = returnTrue
