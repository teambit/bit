...
export class LegacyCommand implements Command {
  ...
  private?: boolean;
  migration?: boolean;
  constructor(private cmd: LegacyInterface, p: CLI) {
    this.name = cmd.name;
...
export function findLegacyDetails(name: string, p: CLI) {
  let group = '';
  let summery = '';
