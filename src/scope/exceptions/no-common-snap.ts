...
Another case of this error is when a lane has a component and the remote of that component has also a component with the same name. to fix this, run "bit lane merge main --resolve-unrelated"`);
  }
}
