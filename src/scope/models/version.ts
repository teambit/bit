...
export type VersionProps = {
  ...
  parents?: Ref[];
  squashed?: Ref[];
  unrelated?: { head: Ref; laneId: LaneId };
...
export default class Version extends BitObject {
  ...
  unrelated?: { head: Ref; laneId: LaneId }; // when a component from a lane was created with the same name/scope as main, this ref points to the component of the lane
  extensions: ExtensionDataList;
  buildStatus?: BuildStatus;
