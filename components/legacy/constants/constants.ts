...
/**
 * generated by npm/yarn. kept apart from IGNORE_LIST so a workspace with `trackAllFiles` can track them.
 */
export const LOCKFILES_IGNORE_LIST = ['**/package-lock.json', '**/yarn.lock'];
 ...
 */
export const IGNORE_ROOT_ONLY_LIST = [
  'tsconfig.json',
  '.eslintrc.json',
  '.prettierrc.cjs',
  '.oxlintrc.json',
...
export const COMPONENT_PATTERN_HELP = `component name, component id, component pattern, or relative directory path. use component pattern to select multiple components.
