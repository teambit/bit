...
import { TableRow, DefaultValueCell } from '@teambit/documenter.ui.table-row';
          ...
          return (
            <TableRow
              ...
              customRow={{
                ...
                default: (_bindingNode as InferenceTypeSchema).defaultValue ? (
                  <DefaultValueCell value={(_bindingNode as InferenceTypeSchema).defaultValue as string} />
                ) : undefined,
              }}
      ...
      <React.Fragment>
        ...
        <TableRow
          ...
          customRow={{
            ...
            default: paramNode.defaultValue ? <DefaultValueCell value={paramNode.defaultValue} /> : undefined,
          }}
          row={{
            name: paramNode.name || '',
