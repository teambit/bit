...
export class ConfigCmd implements Command {
  ...
  extendedDescription = configCommand.extendedDescription;
  group = configCommand.group;
  alias = configCommand.alias;
  loadAspects = configCommand.loadAspects;
  commands: Command[] = configCommand.commands;
