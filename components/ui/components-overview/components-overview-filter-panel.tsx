...
import type { WorkspaceItem, AggregationType } from './components-overview.types';
import styles from './components-overview.module.scss';

export interface ComponentsOverviewFilterPanelProps {
...
export function ComponentsOverviewFilterPanel({
  aggregation,
  onAggregationChange,
  ...
  activeScopes,
  onScopesChange,
}: ComponentsOverviewFilterPanelProps) {
