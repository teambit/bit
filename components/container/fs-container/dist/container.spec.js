...
describe('FsContainer', function () {
    ...
    describe('exec()', function () {
        ...
        it('should return stdout', function () { return __awaiter(_this, void 0, void 0, function () {
            var execResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, container.exec({ command: ['pwd'] })];
                    case 1:
                        execResults = _a.sent();
        ...
        it('should run on the capsule directory', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        it('should return stderr', function () { return __awaiter(_this, void 0, void 0, function () {
            var execResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, container.exec({ command: ['pwd'] })];
        ...
        it('should return stdin', function () { return __awaiter(_this, void 0, void 0, function () {
            var execResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, container.exec({ command: ['pwd'] })];
        ...
        it('should have abort method', function () { return __awaiter(_this, void 0, void 0, function () {
            var execResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, container.exec({ command: ['pwd'] })];
        ...
        it('should have inspect method', function () { return __awaiter(_this, void 0, void 0, function () {
            var execResults;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, container.exec({ command: ['pwd'] })];
        ...
        it('inspect() should return the pid and the running status', function () { return __awaiter(_this, void 0, void 0, function () {
