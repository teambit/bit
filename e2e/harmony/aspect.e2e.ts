...
describe('aspect', function () {
  ...
  describe('aspect loading failures', () => {
    before(() => {
      ...
      // the aspect env is not a core aspect - without installing it, the aspect fails to load with
      // an env-loading error instead of the error this test exercises. after the install the env
      // links @teambit/harmony so the aspect loads fine - fail the load explicitly with a require
